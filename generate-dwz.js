...
async function generateDWZTable() {
    try {
        ...
        const outputPath = path.join(__dirname, 'dist', 'dwz-liste-dynamic.html');
        fs.writeFileSync(outputPath, outputHtml);
        console.log('DWZ table generated at', outputPath);

    } catch (err) {
        console.error('Error generating DWZ table:', err);
    }
}
